    ...
    <table class="min-w-full">
      ...
      <tbody>
        <tr class="even:bg-gray-100 odd:bg-white border-b" v-for="d in lastData" :key="d._id">
          ...
          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ d.temperature }} °C</td>
          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ d.humidity }}%</td>
          <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">{{ d.pressure }} hPa</td>
